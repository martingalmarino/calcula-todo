...
export default function DivisoesClientPT() {
  ...
  return (
    <GameLayoutPT
      ...
      introduction="Você verá divisões e deve resolver mentalmente. Pratique sua agilidade com divisões! Tem 50 segundos!"
      timeLeft={timeLeft}
      score={score}
      onStart={startGame}
      onReset={resetGame}
      ...
      currentGamePath="/pt/jogos-matematicos/divisoes"
    >
      {gameState === 'waiting' && (
        <div className="text-center space-y-6">
          <div className="text-6xl mb-4">➗</div>
          <h2 className="text-2xl font-bold text-gray-800 mb-4">
            Calculadora Mental de Divisões!
          </h2>
          <p className="text-gray-600 text-lg max-w-md mx-auto">
            Você verá divisões e deve resolver mentalmente. Pratique sua agilidade com divisões! 
            Tem 50 segundos!
          </p>
        </div>
      )}
