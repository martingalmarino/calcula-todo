...
const generateProblem = (): MixedOperationProblem => {
  ...
  return { operation: operationText, correctAnswer, options }
}

export default function OperacoesMistasClientPT() {
  ...
  return (
    <GameLayoutPT
      ...
      introduction="Você verá operações mistas (soma, subtração, multiplicação, divisão) e deve resolver rapidamente. Tem 50 segundos!"
      timeLeft={timeLeft}
      score={score}
      onStart={startGame}
      onReset={resetGame}
      ...
      currentGamePath="/pt/jogos-matematicos/operacoes-mistas"
    >
      {gameState === 'waiting' && (
        <div className="text-center space-y-6">
          <div className="text-6xl mb-4">⚡</div>
          <h2 className="text-2xl font-bold text-gray-800 mb-4">
            Operações Mistas Rápidas!
          </h2>
          <p className="text-gray-600 text-lg max-w-md mx-auto">
            Você verá operações mistas (soma, subtração, multiplicação, divisão) e deve resolver rapidamente. 
            Tem 50 segundos!
          </p>
        </div>
      )}
