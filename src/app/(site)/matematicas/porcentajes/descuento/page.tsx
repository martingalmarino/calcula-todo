...
export default function DescuentosPage() {
  return (
    <Container>
      <div className="py-8">
        <Breadcrumbs 
          items={getBreadcrumbs('/matematicas/porcentajes/descuento/')} 
          className="mb-8"
        />
        ...
        <div className="text-center space-y-6 mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Calcula descuentos y precios finales con explicaciones paso a paso
          </p>
        </div>
        ...
        <Card className="text-center">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              Mientras tanto, puedes usar nuestra calculadora general de porcentajes que incluye la funcionalidad de descuentos.
            </p>
            <Button asChild>
