            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <Card className="calculator-card">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-blue-900 mb-2">5 Minuti</h3>
                  <p className="text-sm text-gray-600">Tempo limite per quiz</p>
                </CardContent>
              </Card>
              <Card className="calculator-card">
                <CardContent className="p-6 text-center">
                  <Trophy className="h-8 w-8 mx-auto mb-3 text-blue-600" />
                  <h3 className="font-semibold text-blue-900 mb-2">Conoscenza</h3>
                  <p className="text-sm text-gray-600">Metti alla prova la tua saggezza</p>
                </CardContent>
              </Card>
              <Card className="calculator-card">
                <CardContent className="p-6 text-center">
                  <Brain className="h-8 w-8 mx-auto mb-3 text-blue-600" />
                  <h3 className="font-semibold text-blue-900 mb-2">{totalQuestions} Domande</h3>
                  <p className="text-sm text-gray-600">Impara mentre giochi</p>
                </CardContent>
              </Card>
            </div>
            {/* Start Button */}
          ...
          <Card className="calculator-card mt-6 border-blue-200 bg-blue-50">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-blue-700 mb-4">
                Punteggio: {quizResult.points} punti - Livello: {getRankInfo(quizResult.points).rank}
              </p>
              <div className="space-y-3">
                <Button
                  onClick={onReset}
