...
export const calculatorTitles: Record<string, string> = {
  ...
  '/tecnologia/conversion-almacenamiento/': 'Calculadora de Conversión de Almacenamiento - KB, MB, GB, TB',
  '/tecnologia/velocidad-descarga/': 'Calculadora de Velocidad de Descarga - Mbps a MB/s',
  '/tecnologia/uptime-downtime/': 'Calculadora de Uptime/Downtime - Porcentaje de Disponibilidad',
  '/tecnologia/conversion-colores/': 'Calculadora de Conversión de Colores - HEX, RGB, CMYK, HSL',
  '/tecnologia/analisis-contraseñas/': 'Analizador de Contraseñas - Entropía y Fortaleza de Contraseñas',
  '/tecnologia/analisis-latencia/': 'Analizador de Latencia - Ping y Tiempo de Respuesta',
